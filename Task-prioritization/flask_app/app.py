...
[
    Task("2024 Fall class", 10, 30, ["Leetcode"], mandatory=True, fractionable=False),
    Task("Leetcode", 6, 40, [], mandatory=False, fractionable=True),
    Task("Assignments and Exams", 10, 90, ["2024 Fall class"], mandatory=True, fractionable=False),
    Task("Networking event", 7, 3, [], mandatory=False, fractionable=False),
    Task("Job Searching and Preparation", 10, 25, ["Leetcode"], mandatory=True, fractionable=False),
    Task("Shopping and Household", 10, 6, [], mandatory=False, fractionable=False),
    Task("Exercise and Outdoor Activity", 10, 10, [], mandatory=False, fractionable=False)
],
[
    Task("Shopping and Household", 4, 12, [], mandatory=False, fractionable=False),
    Task("Assignments and Exams", 5, 30, ["2024 Fall class"], mandatory=True, fractionable=False),
    Task("2024 Fall class", 5, 24, [], mandatory=True, fractionable=False),
...
[
    ...
    Task("2024 Fall class", 6, 20, [], mandatory=True, fractionable=False),
    ...
    Task("Assignments and Exams", 8, 60, [], mandatory=True, fractionable=False),
    Task("Exercise and Outdoor Activity", 5, 15, [], mandatory=False, fractionable=False)
],
[
    Task("2024 Fall class", 8, 24, [], mandatory=True, fractionable=False),
...
[
    ...
    Task("Assignments and Exams", 6, 40, [], mandatory=True, fractionable=False),
...
[
    Task("2024 Fall class", 10, 24, [], mandatory=True, fractionable=False),
...
[
    ...
    Task("2024 Fall class", 4, 30, [], mandatory=True, fractionable=True),
    Task("Exercise and Outdoor Activity", 7, 15, [], mandatory=False, fractionable=True),
